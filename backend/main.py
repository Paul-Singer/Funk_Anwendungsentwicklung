...
def compute_station_data_cached(cache_epoch: int, station_id: str, start_year: int, end_year: int) -> Dict[str, Any]:
    _ = cache_epoch
...
def api_station_annual(
    ...
    try:
        ...
        return compute_station_data_cached(cache_epoch, station_id, startYear, endYear)
